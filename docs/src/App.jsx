...
function LandingPage() {
	return (
		<main>
			...
			<p>
				Explore examples to learn how to build maps and add custom
				layers.
			</p>
...
function AnnotationPage() {
	return (
		<main>
			...
			<p>
				This example shows how to add a basic annotation using the
				react-simple-maps <code>{'<Annotation />'}</code> component.
			</p>
...
function WorldPage() {
	return (
		<main>
			...
			<p>
				This example illustrates the easiest way to display a world map
				based on a custom topojson file. You can replace the map file
				with any valid topojson file.
			</p>
			<p>
				Since this example focuses on the simplest possible version of a
				world map it omits the implementation of zooming and panning. If
				you are interested in the ZoomableGroup component and in adding
				zooming and panning capabilities to your map, check out the
				zoom-pan example.
			</p>
			<ComposableMap projectionConfig={{ scale: 140 }}>
				<Geographies geography={geoUrl}>
...
function MarkersPage() {
	return (
		<main>
			...
			<h1>Basic markers</h1>
			<p>
				This example shows how to add basic markers to a map. To see an
				example of how to add custom SVG markers, see the custom markers
				example.
			</p>
			<ComposableMap projectionConfig={{ scale: 140 }}>
				<Geographies geography={geoUrl}>
				...
				<Marker coordinates={[-74.006, 40.7128]}>
					...
					<text
						textAnchor="middle"
						y={-12}
						style={{ fill: '#312e81', fontSize: '12px' }}
					>
						New York
					</text>
				</Marker>
...
function GraticulePage() {
	return (
		<main>
			...
			<p>
				This example shows how to use react-simple-maps to make a map of
				Europe with graticule. It uses the built-in{' '}
				<code>geoAzimuthalEqualArea</code> projection with custom
				rotation params.
			</p>
			<ComposableMap
...
function TexturePage() {
	return (
		<main>
			...
			<p>
				This map shows how to use react-simple-maps to add textures on
				the map. This example uses PatternLines from VX to create a line
				texture.
			</p>
			<ComposableMap projectionConfig={{ scale: 140 }}>
				<defs>
